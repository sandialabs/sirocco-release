...
#    include <ssm/ext/boost/preprocessor/list/detail/edg/fold_left.hpp>
# elif BOOST_PP_CONFIG_FLAGS() & BOOST_PP_CONFIG_DMC()
#    include <ssm/ext/boost/preprocessor/list/detail/dmc/fold_left.hpp>
# else
#    include <ssm/ext/boost/preprocessor/list/detail/fold_left.hpp>
# endif
#
