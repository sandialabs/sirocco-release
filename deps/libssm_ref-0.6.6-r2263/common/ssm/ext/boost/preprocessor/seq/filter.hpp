...
# include <ssm/ext/boost/preprocessor/control/expr_if.hpp>
# include <ssm/ext/boost/preprocessor/facilities/empty.hpp>
# include <ssm/ext/boost/preprocessor/seq/fold_left.hpp>
