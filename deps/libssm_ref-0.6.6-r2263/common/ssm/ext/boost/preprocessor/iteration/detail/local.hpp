...
#        include <ssm/ext/boost/preprocessor/iteration/detail/start.hpp>
#        define BOOST_PP_VALUE BOOST_PP_TUPLE_ELEM(2, 1, BOOST_PP_LOCAL_LIMITS)
#        include <ssm/ext/boost/preprocessor/iteration/detail/finish.hpp>
...
#    include <ssm/ext/boost/preprocessor/iteration/detail/rlocal.hpp>
# else
